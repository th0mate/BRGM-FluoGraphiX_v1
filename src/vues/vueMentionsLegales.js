function vueMentionsLegales() {
    ...
    <div class="cookies">
        ...
        <p>Pierre Vassal, responsable de la Communication, de la Médiation scientifique et des Éditions du BRGM</p>
        <br>
    
        <h4>Responsable éditoriale</h4>
        <p>Aude Rouger-Loiseau, chargée de la communication digitale, service de la Communication de la Médiation scientifique et des Éditions</p>
        <br>
    
        <h4>Webmaster technique</h4>
        <p>Fabrice Catonet, responsable de l'unité Équipements et services aux utilisateurs, secrétariat général, service Systèmes d'information</p>
        <br>
    
        <h3>Coordonnées</h3>
        <p>BRGM</p>
        <p>3 avenue Claude-Guillemin, BP 36009</p>
        <p>45060 Orléans Cedex 02</p>
        <p>France</p>
        ...
        <p>Code APE (NAF) : 7219Z</p>
        <p>Numéro SIREN : 582 056 149</p>
        <p>Numéro SIRET (siège) : 58205614900120</p>
        <p>Numéro RCS : RCS Orléans 582 056 149</p>
        ...
        <h3>Hébergement</h3>
        <p>BRGM</p>
        <p>Direction des Infrastructures et des Services Numériques</p>
        <p>3 avenue Claude-Guillemin, BP 36009</p>
        <p>45060 Orléans Cedex 02</p>
        <p>France</p>

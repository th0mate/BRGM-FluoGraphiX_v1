    ...
    <div class="documentation">
        ...
        <div>
            ...
            <span>
                ...
                <datalist id="recherche"></datalist>
    ...
    <div class="documentationMain">
        ...
        <div class="bandeauDocumentation">
            <div>
                ...
                <a href="#lancementDoc"><span></span>Lancement</a>
                <a href="#presentationDoc"><span></span>Présentation</a>
            </div>
            
            <div>
                <h3>Graphiques</h3>
                <a href="#paramGraphiqueDoc"><span></span>Paramètres</a>
                <a href="#importGraphiqueDoc"><span></span>Importation</a>
                <a href="#expGraphiqueDoc"><span></span>Exportation</a>
                <a href="#GraphiqueDoc"><span></span>Graphique</a>
            </div>
        ...
        <div class="documentationContenu">
            ...
            <div class="section">
                <h3>Présentation & Installation</h3>
                <h1 id="installationDoc" class="titreBarre">Installation</h1>
                ...
                <div class="etape">
                    <div>
                        <h3><span>1</span>Téléchargement depuis le site</h3>
                ...
                <div class="etape">
                    <div>
                        <h3><span>2</span>Installation de l'outil FluoriGraphix</h3>
            ...
            <div class="section">
                <h3>Présentation & Installation</h3>
                <h1 id="lancementDoc" class="titreBarre">Lancement</h1>
                <div class="etape">
                    <div>
                        <h3><span>1</span>Premier Lancement</h3>
                ...
                <div class="etape">
                    <div>
                        <h3><span>2</span>Utilisation de cookies</h3>
            ...
            <div class="section">
                <h3>Présentation & Installation</h3>
                <h1 id="presentationDoc" class="titreBarre">Présentation</h1>
                <div class="etape">
                    <div>
                        <h3><span>1</span>Présentation générale</h3>
                ...
                <div class="etape">
                    <div>
                        <h3><span>2</span>Page d'accueil</h3>
                ...
                <div class="etape">
                    <div>
                        <h3><span>3</span>Page de documentation</h3>
                ...
                <div class="etape">
                    <div>
                        <h3><span>5</span>Page des Concentrations</h3>
                ...
                <div class="etape">
                    <div>
                        <h3><span>6</span>Page des Graphiques</h3>
            ...
            <div class="section">
                <h3>Graphiques</h3>
                <h1 id="paramGraphiqueDoc" class="titreBarre">Paramètres</h1>
                ...
                <div class="etape">
                    <div>
                        <h3><span>1</span>Sélection de fichiers</h3>
                ...
                <div class="etape">
                    <div>
                        <h3><span>2</span>Refus automatique</h3>
                ...
                <div class="etape">
                    <div>
                        <h3><span>3</span>Zoom et déplacement</h3>
                ...
                <div class="etape">
                    <div>
                        <h3><span>4</span>Formats de dates - Détection automatique</h3>
            ...
            <div class="section">
                <h3>Graphiques</h3>
                <h1 id="importGraphiqueDoc" class="titreBarre">Importation</h1>
                
                <div class="etape">
                    <div>
                        <h3><span>1</span>Importation de fichiers</h3>
                ...
                <div class="etape">
                    <div>
                        <h3><span>2</span>Fichiers .dat</h3>
                ...
                <div class="etape">
                    <div>
                        <h3><span>3</span>Signaler un bug</h3>
